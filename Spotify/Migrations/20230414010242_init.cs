        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ArtTypes_Artists_ArtistId",
                        column: x => x.ArtistId,
                        principalTable: "Artists",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_ArtTypes_Types_TypeId",
                        column: x => x.TypeId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SongsTypes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SongsTypes_Songs_SongId",
                        column: x => x.SongId,
                        principalTable: "Songs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_SongsTypes_Types_TypeId",
                        column: x => x.TypeId,
                        principalTable: "Types",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ArtTypes_ArtistId",
                table: "ArtTypes",
                column: "ArtistId");

            migrationBuilder.CreateIndex(
                name: "IX_ArtTypes_TypeId",
                table: "ArtTypes",
                column: "TypeId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SongsTypes_SongId",
                table: "SongsTypes",
                column: "SongId");

            migrationBuilder.CreateIndex(
                name: "IX_SongsTypes_TypeId",
                table: "SongsTypes",
                column: "TypeId");
        }
